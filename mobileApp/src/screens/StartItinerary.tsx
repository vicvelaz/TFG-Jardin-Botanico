...
import { StyleSheet, View, Alert, TouchableOpacity, Text, ActivityIndicator, Image, Pressable, TouchableWithoutFeedback, ScrollView } from "react-native";
...
export const StartItinerary = ({ route, navigation }: Props) => {
  ...
  const swipeUpDownRef = React.useRef<any>();
              ...
              <View style={textStyle.imageButtonsView}>
                ...
                <View>
                  ...
                  <TouchableOpacity style={buttonStyle.button}
                    ...
                    <Text style={buttonStyle.buttonTextMin}>Volver a Itinerario</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>}
